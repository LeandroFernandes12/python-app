...
resultado_seno = tk.Label(frame_resultados, text="", font=('Arial', 12, 'bold'), fg='red', bg="#f0f0f0")  # Rótulo para o resultado do seno
resultado_seno.grid(row=0, column=1, sticky="w", padx=10, pady=5)

# Label e resultado para o Cosseno
label_cosseno = tk.Label(frame_resultados, text="Cosseno:", font=('Arial', 14), bg="#f0f0f0") 
...
label_tangente = tk.Label(frame_resultados, text="Tangente:", font=('Arial', 14), bg="#f0f0f0") 
