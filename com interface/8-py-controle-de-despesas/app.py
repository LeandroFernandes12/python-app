...
def get_db_path():
    ...
    return os.path.join(application_path, 'controle_despesas.db')
...
class TelaCadastro(ctk.CTk):
    ...
    def set_icon(self):
        icon_path = resource_path("dinheiro.ico")
        try:
    ...
    def setup_ui(self):
        self.title("Controle de despesas")
        ...
        try:
            icon_image = Image.open(resource_path("dinheiro.png"))
        ...
        # Título
        self.label = ctk.CTkLabel(self.top_frame, text="Controle de despesas", font=("Roboto", 24))
        ...
        self.motivo_entry = ctk.CTkEntry(self.frame, placeholder_text="Motivo")
        self.motivo_entry.pack(pady=5, padx=10)
        self.valor_entry = ctk.CTkEntry(self.frame, placeholder_text="Valor")
        self.valor_entry.pack(pady=5, padx=10)
        self.tipo_entry = ctk.CTkComboBox(self.frame, values=["Despesa", "Receita"])
        self.tipo_entry.pack(pady=5, padx=10)
        ...
        self.tree = ttk.Treeview(self.frame, columns=("ID", "Motivo", "Valor", "Data"), show="headings")
        self.tree.heading("ID", text="ID", anchor="center")
        self.tree.heading("Motivo", text="Motivo", anchor="center")
        self.tree.heading("Valor", text="Valor", anchor="center")
        self.tree.heading("Data", text="Tipo", anchor="center")
        self.tree.column("ID", width=50, anchor="center")
        self.tree.column("Motivo", width=200, anchor="center")
