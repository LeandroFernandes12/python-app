...
class TelaFinancas(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.label_titulo = ctk.CTkLabel(self.top_frame, text="Gerenciador de Despesas", 
                                        font=("Arial", 24, "bold"))
        self.label_titulo.pack(anchor="center", pady=10)
        ...
        self.adicionar_btn = ctk.CTkButton(self.btn_frame, text="Adicionar",
                                          fg_color="#37F056", hover_color="#19631d",
                                          width=100, 
        ...
        self.atualizar_btn = ctk.CTkButton(self.btn_frame, text="Atualizar",
                                          fg_color="#4562F0", hover_color="#135291",
                                          width=100,
    ...
    def atualizar_dados(self):
        ...
        self.tree.tag_configure("receita", foreground="#37F056")
    ...
    def atualizar_saldo(self):
        ...
        cor = "#37F056" if saldo >= 0 else "#F44336"
